...
function Mesh()
{
    ...
    this.prepareToDraw=function()
    {
        ...
        gl.vertexAttribPointer(WebGLMacros.NRC_ATTRIBUTE_VERTEX,
                               3,
                               gl.FLOAT,
                               false,0,0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      norms,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.NRC_ATTRIBUTE_NORMAL,
                               3,
                               gl.FLOAT,
                               false,0,0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      texCoords,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.NRC_ATTRIBUTE_TEXTURE0,
