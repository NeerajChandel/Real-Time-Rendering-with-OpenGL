/*
*   Program:    Orthographic single-colored triangle in WebGL 2.0
*/
...
function init()
{
    ...
    orthographicProjectionMatrix = mat4.create();   //  create() creates a 16-member array and fills it with identity matrix
...
function resize()
{
    ...
    //  set orthographic-projection-matrix (LRBTNF)
