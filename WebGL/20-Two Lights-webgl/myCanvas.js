/*
*   Program:    Two Lights in WebGL 2.0
*/
...
function init()
{
    ...
    laUniform_red = gl.getUniformLocation(shaderProgramObject, "u_La_0");
    ldUniform_red = gl.getUniformLocation(shaderProgramObject, "u_Ld_0");
    lsUniform_red = gl.getUniformLocation(shaderProgramObject, "u_Ls_0");
    lightPositionUniform_red = gl.getUniformLocation(shaderProgramObject, "u_light_position_0");
    laUniform_blue = gl.getUniformLocation(shaderProgramObject, "u_La_1");
    ldUniform_blue = gl.getUniformLocation(shaderProgramObject, "u_Ld_1");
    lsUniform_blue = gl.getUniformLocation(shaderProgramObject, "u_Ls_1");
    lightPositionUniform_blue = gl.getUniformLocation(shaderProgramObject, "u_light_position_1");
