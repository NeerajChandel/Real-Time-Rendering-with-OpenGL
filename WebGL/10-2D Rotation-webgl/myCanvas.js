/*
*   Program:    2D Rotation in WebGL 2.0
*/
...
function draw()
{
    ...
    mat4.rotateX(rotateMatrix, rotateMatrix, degToRad(angle_sq));
...
function update()
{
    angle_tri = angle_tri + 1.0;
    if (angle_tri >= 360.0)
        angle_tri = 0.0;

    angle_sq = angle_sq - 1.0;
    if (angle_sq <= -360.0)
        angle_sq = 0.0;
}
