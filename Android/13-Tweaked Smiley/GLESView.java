package com.window.tweak.neeraj;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    private void resize(int width, int height)
    {
        ...
        Matrix.perspectiveM(perspectiveProjectionMatrix, 0, 60.0f, (float)width/(float)height, 0.1f, 100.0f);
    }
    ...
    public void display()
    {
       ...
       // Matrix.scaleM(modelViewMatrix, 0, 0.5f, 0.5f, 0.5f);
        ...
        colorBuffer.position(0);  
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, quadTexture.length * 4, colorBuffer, GLES32.GL_DYNAMIC_DRAW);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
